            ...
            <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
              ...
              <div>
                ...
                <div class="flex items-center justify-center gap-4 text-center wow fadeInUp" data-wow-delay=".3s">
                  <?php
                  $default_brands = [
                    get_template_directory_uri() . '/assets/images/brands/ayroui-white.svg',
                    get_template_directory_uri() . '/assets/images/brands/graygrids-white.svg',
                    get_template_directory_uri() . '/assets/images/brands/lineicons-white.svg',
                    get_template_directory_uri() . '/assets/images/brands/tailgrids-white.svg',
                    get_template_directory_uri() . '/assets/images/brands/uideck-white.svg',
                  ];
                  for ($i = 1; $i <= 5; $i++) :
              ...
              <div class="<?php echo $item_class; ?>">
                <div class="rounded-xl bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px] h-full">
                  <div class="mb-[18px] flex items-center gap-[2px]">
                    <?php
                    $rating = 0; // Default to 0 if not set
                    if (function_exists('get_field') && get_field('star_rating')) {
                        $rating = intval(get_field('star_rating'));
                    }

                    $star_icon_url = '';
                    $star_icon_mod = get_theme_mod('testimonial_star_icon');

                    if (is_numeric($star_icon_mod)) {
                        $star_icon_url = wp_get_attachment_image_url($star_icon_mod, 'full');
                    } elseif (filter_var($star_icon_mod, FILTER_VALIDATE_URL)) {
                        $star_icon_url = $star_icon_mod;
                    }
                    ...
                    for ($i = 1; $i <= 5; $i++) {
                        $star_class = ($i <= $rating) ? '' : 'filter grayscale opacity-30';
                        echo '<img src="' . esc_url($star_icon_url) . '" alt="star icon" class="' . $star_class . '" />';
                    }
                    ?>
                  </div>
